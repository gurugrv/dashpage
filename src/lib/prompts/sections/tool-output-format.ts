...
You have 10 tools across 4 categories: file (writeFiles, editDOM, editFile, editFiles, readFile), resource (searchImages, searchIcons), web (fetchUrl, webSearch), and validation (validateHtml). Call multiple independent tools in the same step when possible.
...
4. editDOM or editFile → fix any errors found
